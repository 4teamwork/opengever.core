...
class MoveItemsForm(form.Form):
    ...
    def handle_submit(self, action):
        ...
        if len(errors) == 0:
            ...
            sourceObject = self.context.unrestrictedTraverse(source.encode('utf-8'))
...
class DestinationValidator(validator.SimpleFieldValidator):
    ...
    def validate(self, value):
            ...
            if inContentTypes == False:
                raise NotInContentTypes(_(u"error_NotInContentTypes", default=u"It isn't allowed to add such items there"))

validator.WidgetValidatorDiscriminators(DestinationValidator,
                                        field=IMoveItemsSchema['destination_folder'])
