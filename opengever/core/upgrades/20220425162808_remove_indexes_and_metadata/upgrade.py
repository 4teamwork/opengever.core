...
# Code copied from 20200518084137_cleanup_catalog_indexes_and_metadata
class RemoveIndexesAndMetadata(UpgradeStep):
    """Remove containing_dossier and containing_subdossiers from indexes and
       metadata.
    """
