...
TO_REMOVE = ['grokcore.component.interfaces.IContext']


class CleanupGrokcoreComponentInterfacesIContextInterfacesFromRelationCatalog(UpgradeStep):
    """Cleanup grokcore.component.interfaces.IContext interfaces from relation
    catalog due to ungrokking the package.

    But because the zc.relation cataog persists provided interfaces,
    the removed interfaces must be removed manually from the zc.relation catalog.
