...
class TestResolveGUID(FunctionalTestCase):
    ...
    def test_reorders_items_parents_before_children(self):
        ...
        self.assertEqual([
                {'guid': 1337, '_nesting_depth': 1},
                {'guid': 'qux', 'parent_guid': 1337, '_nesting_depth': 2},
                {'guid': 1, '_nesting_depth': 1},
                {'guid': 2, 'parent_guid': 1, '_nesting_depth': 2},
                {'guid': 3, 'parent_guid': 2, '_nesting_depth': 3},
            ],
            list(section)
        )
