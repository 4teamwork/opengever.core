...
class BaseContextActions(object):
    ...
    def get_actions(self):
        ...
        self.maybe_export_dossier_participations()
        return self.actions
    ...
    def maybe_export_dossier_participations(self):
        if self.is_export_dossier_participations_available():
            self.add_action(u'export_dossier_participations')
