...
def is_user_visible_error_logs_feature_enabled():
    return api.portal.get_registry_record(
        'is_user_visible_error_logs_feature_enabled', interface=IBaseSettings)
...
class ErrorLogRedis:
    ...
    def list_all_by_userid(self, userid):
...
class DisabledErrorLogRedis:
    ...
    def list_all_by_userid(self, *args, **kwargs):
        return []
...
def get_error_log_redis():
    if is_user_visible_error_logs_feature_enabled():
        return ErrorLogRedis(redis_client_manager.get_client())
    return DisabledErrorLogRedis()
