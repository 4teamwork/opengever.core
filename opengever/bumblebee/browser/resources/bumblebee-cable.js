...
var bumblebeeNodes = {
  ...
  gather: function gather() {
    ...
    this.data = {};
    (0, _helpers.toArray)(document.querySelectorAll("[data-bumblebee-checksum]")).forEach(function (node) {
...
var BumblebeeCable = {
  ...
  connect: function connect(url) {
    ...
    this.subscription = consumer.subscriptions.create("DocumentChannel", {
