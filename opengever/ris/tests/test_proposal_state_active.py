...
class TestRisProposalStateActive(IntegrationTestCase):

    features = ('ris',)

    def setUp(self):
        super(TestRisProposalStateActive, self).setUp()
    ...
    def test_visible_actions_for_dossier_responsible(self, browser):
        ...
        self.assertEqual(editbar.menu_options('Actions'), ['Cancel', 'Submit'])
    ...
    def test_visible_actions_for_manager(self, browser):
        ...
        self.assertEqual(
            ...
            [
                'Sharing',
                'Cancel',
                'Cancel (Manager: Debug)',
                'Submit',
                'Submit (Manager: Debug)',
                'Policy...',
            ]
        )
