...
class TestRisProposalTransitionSubmitToMeeting(IntegrationTestCase):

    features = ('ris',)

    def setUp(self):
        super(TestRisProposalTransitionSubmitToMeeting, self).setUp()
    ...
    @browsing
    def test_proposal_submit_to_meeting_api_transition_sets_wokflow_state(self, browser):
        self.login(self.dossier_responsible, browser)

        url = '{}/@workflow/proposal-transition-submit-to-meeting'.format(
    ...
    @browsing
    def test_proposal_submit_to_meeting_api_transition_requires_modify_portal_content(self, browser):
