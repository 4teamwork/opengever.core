...
class TestRisProposalTransitionReject(IntegrationTestCase):

    features = ('ris',)

    def setUp(self):
        super(TestRisProposalTransitionReject, self).setUp()
    ...
    @browsing
    def test_proposal_reject_api_transition_sets_wokflow_state(self, browser):
        self.login(self.dossier_responsible, browser)

        url = '{}/@workflow/proposal-transition-reject'.format(
    ...
    @browsing
    def test_proposal_reject_api_transition_requires_modify_portal_content(self, browser):
    ...
    @browsing
    def test_proposal_reject_debug_action_sets_wokflow_state(self, browser):
        self.login(self.manager, browser)

        browser.open(self.ris_proposal)
        editbar.menu_option('Actions', 'Reject (Manager: Debug)').click()
