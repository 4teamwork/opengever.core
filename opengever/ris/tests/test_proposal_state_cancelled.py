...
class TestRisProposalStateCancelled(IntegrationTestCase):

    features = ('ris',)

    def setUp(self):
        super(TestRisProposalStateCancelled, self).setUp()
    ...
    def test_visible_actions_for_dossier_responsible(self, browser):
        ...
        self.assertEqual(editbar.menu_options('Actions'), ['Reopen'])
