...
class TestRisProposalTransitionCancel(IntegrationTestCase):

    features = ('ris',)

    def setUp(self):
        super(TestRisProposalTransitionCancel, self).setUp()
    ...
    @browsing
    def test_proposal_cancel_action_redirects_to_ris(self, browser):
    ...
    @browsing
    def test_proposal_cancel_api_transition_sets_wokflow_state(self, browser):
        self.login(self.dossier_responsible, browser)
        ...
        self.assert_workflow_state('proposal-state-cancelled', self.ris_proposal)

    @browsing
    def test_proposal_cancel_api_transition_requires_modify_portal_content(self, browser):
    ...
    @browsing
    def test_proposal_cancel_debug_action_sets_wokflow_state(self, browser):
        self.login(self.manager, browser)

        browser.open(self.ris_proposal)
        editbar.menu_option('Actions', 'Cancel (Manager: Debug)').click()
