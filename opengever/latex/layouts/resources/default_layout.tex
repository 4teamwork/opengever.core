...
%% Forced Hyphenation inside table
%%%% This allows Latex to split very long words inside tables
%%%% THe function below forces a hyphen during splits
\makeatletter
