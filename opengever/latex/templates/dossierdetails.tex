...
% if subdossiers:
  ...
  {\bf Subdossiers}\\
  \vspace{1mm}
  \tablehead{\bfseries Nr. & \bfseries Ablagenr. & \bfseries Titel & \bfseries Federführend & \bfseries Status & \bfseries Beginn\\ \hline}
...
% if documents:
  ...
  {\bf Dokumente}\\
  \vspace{1mm}
  \tablehead{\bfseries Nr. & \bfseries Titel & \bfseries Dokument-Datum & \bfseries Eingangsdatum & \bfseries Autor\\ \hline}
  \begin{supertabular*}{\textwidth}{p{5mm}p{70mm}p{22mm}p{22mm}p{25mm}}
