# ./opengever/disposition/ech0160/bindings/zusatzDaten.py
# -*- coding: utf-8 -*-
# PyXB bindings for NM:e92452c8d3e28a9e27abfc9994d2007779e7f4c9
# Generated 2016-11-15 15:31:48.917841 by PyXB version 1.2.5 using Python 2.7.11.final.0
# Namespace AbsentNamespace12
...
class historischerZeitpunkt (pyxb.binding.basis.complexTypeDefinition):
    ...
    __ca = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'ca'), 'ca', '__AbsentNamespace12_historischerZeitpunkt_ca', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 9, 6), )
    ...
    __datum = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'datum'), 'datum', '__AbsentNamespace12_historischerZeitpunkt_datum', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 10, 6), )
...
class historischerZeitraum (pyxb.binding.basis.complexTypeDefinition):
    ...
    __von = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'von'), 'von', '__AbsentNamespace12_historischerZeitraum_von', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 16, 6), )
    ...
    __bis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'bis'), 'bis', '__AbsentNamespace12_historischerZeitraum_bis', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 17, 6), )
...
class zeitraum (pyxb.binding.basis.complexTypeDefinition):
    ...
    # Element von uses Python identifier von
    __von = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'von'), 'von', '__AbsentNamespace12_zeitraum_von', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 69, 6), )
    ...
    # Element bis uses Python identifier bis
    __bis = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'bis'), 'bis', '__AbsentNamespace12_zeitraum_bis', False, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/base.xsd', 70, 6), )
...
# Complex type zusatzDaten with content type ELEMENT_ONLY
class zusatzDaten (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 7, 2)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element merkmal uses Python identifier merkmal
    __merkmal = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'merkmal'), 'merkmal', '__AbsentNamespace12_zusatzDaten_merkmal', True, pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 15, 6), )
...
class CTD_ANON (pyxb.binding.basis.complexTypeDefinition):
    ...
    _Abstract = False
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 16, 8)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is text4
    
    # Attribute name uses Python identifier name
    __name = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'name'), 'name', '__AbsentNamespace12_CTD_ANON_name', _module_typeBindings.text4, required=True)
    __name._DeclarationLocation = pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 19, 14)
    __name._UseLocation = pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 19, 14)
...
zusatzDaten._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'merkmal'), CTD_ANON, scope=zusatzDaten, location=pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 15, 6)))
...
def _BuildAutomaton_3 ():
    ...
    states = []
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(zusatzDaten._UseForTag(pyxb.namespace.ExpandedName(None, 'merkmal')), pyxb.utils.utility.Location('/Users/flipsi/projects/opengever/28/opengever/disposition/ech0160/schemas/zusatzDaten.xsd', 15, 6))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    transitions = []
    transitions.append(fac.Transition(st_0, [
    ...
    st_0._set_transitionSet(transitions)
    return fac.Automaton(states, counters, False, containing_state=None)
zusatzDaten._Automaton = _BuildAutomaton_3()
