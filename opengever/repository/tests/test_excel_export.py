...
class TestRepositoryRootExcelExport(IntegrationTestCase):
    ...
    def test_importability_of_exported_repository_root(self):
        ...
        expected_reporoot = {
            ...
            u'Classification': u'',
            u'Close dossiers local or inherited roles': u'jurgen.konig',
            u'Close dossiers local roles': u'jurgen.konig',
            u'Comment about archival value assessment': u'',
            u'Comment about retention period assessment': u'',
            u'Create dossiers local or inherited roles': u'fa_users, jurgen.fischer',
            u'Create dossiers local roles': u'jurgen.fischer,fa_users',
            ...
            u'Reactivate dossiers local or inherited roles': u'jurgen.konig',
            u'Reactivate dossiers local roles': u'jurgen.konig',
