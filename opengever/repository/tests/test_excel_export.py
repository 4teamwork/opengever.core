...
class TestRepositoryRootExcelExport(IntegrationTestCase):
    ...
    def test_importability_of_exported_repository_root(self):
        ...
        expected_reporoot = {
                ...
                u'archivalValueAnnotation': u'',
                u'Archival value': u'',
                u'Classification': u'',
                u'Custody period (years)': u'',
                u'Privacy layer': u'',
                u'Public Trial': u'',
                u'retentionPeriodAnnotation': u'',
        ...
        expected_repofolder = {
            ...
            u'Edit dossiers': u'',
            u'archivalValueAnnotation': u'',
            u'Archival value': u'unchecked',
            u'Classification': u'unprotected',
            u'Custody period (years)': 30,
            u'Privacy layer': u'privacy_layer_no',
            u'Public Trial': u'unchecked',
            u'retentionPeriodAnnotation': u'',
