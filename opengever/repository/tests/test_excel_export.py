...
class TestRepositoryRootExcelExport(IntegrationTestCase):
    ...
    def test_importability_of_exported_repository_root(self):
        ...
        expected_reporoot = {
            ...
            u'Create dossiers local or inherited roles': u'fa_users, %s' % self.archivist.getId(),
            u'Create dossiers local roles': u'fa_users,%s' % self.archivist.getId(),
            ...
            u'Reactivate dossiers local or inherited roles': self.secretariat_user.getId(),
            u'Reactivate dossiers local roles': self.secretariat_user.getId(),
