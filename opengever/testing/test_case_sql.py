...
from opengever.core.testing import OPENGEVER_FUNCTIONAL_TESTING_SQL
...
class TestCaseSQL(unittest2.TestCase):
    pass


class FunctionalTestCaseSQL(TestCaseSQL):
    layer = OPENGEVER_FUNCTIONAL_TESTING_SQL

    def setUp(self):
        super(FunctionalTestCaseSQL, self).setUp()
    ...
    def assertResponseHeader(self, name, value):
        self.assertEquals(value,
                          self.portal.REQUEST.response.headers.get(name))
