...
class WebActionsStorage(object):
    ...
    def add(self, action_data):
        ...
        if self._action_already_exists_with_unique_name(action_data):
        ...
        # against a schema that constists of the user controlled fields plus
    ...
    def update(self, action_id, action_data):
        # XXX: Document that removal of existing fields is not possible
        ...
        # XXX: Check for permission and action ownership
    ...
    def _action_already_exists_with_unique_name(self, action_data):
