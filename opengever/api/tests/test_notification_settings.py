        ...
        self.assertEqual({
            ...
            u'activities': {
                ...
                u'items': [{
                    ...
                    {u'@id': u'http://nohost/plone/@notification-settings/activities/todo-overdue',
                     u'badge': {u'todo_responsible_role': True,
                                u'workspace_member_role': False},
                     u'digest': {u'todo_responsible_role': False,
                                 u'workspace_member_role': False},
                     u'group': u'todos',
                     u'id': u'todo-overdue',
                     u'kind': u'todo-overdue',
                     u'mail': {u'todo_responsible_role': False,
                               u'workspace_member_role': False},
                     u'personal': False,
                     u'title': u'Overdue to-do'},
                    {u'@id': u'http://nohost/plone/@notification-settings/activities/workspace-participation-added',
                             u'badge': {u'always': True},
                             u'digest': {u'always': False},
                             u'group': u'workspaces',
                             u'id': u'workspace-participation-added',
                             u'kind': u'workspace-participation-added',
                             u'mail': {u'always': True},
                             u'personal': False,
                             u'title': u'Added as workspace participant'},
            ...
            u'general': {
                ...
                u'items': [{
                    ...
                    u'value': False}]},
            u'translations': [
                {u'id': u'todo_responsible_role', u'title': u'To-do responsible'},
                {u'id': u'regular_watcher', u'title': u'Watcher'},
                {u'id': u'workspace_member_role', u'title': u'Workspace member'},
                {u'id': u'always', u'title': u''}]}, browser.json)
