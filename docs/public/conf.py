# -*- coding: utf-8 -*-
#
# OneGov GEVER API documentation build configuration file, created by
...
htmlhelp_basename = 'OneGovGEVERAPIdoc'
...
latex_documents = [
    (master_doc, 'OneGovGEVERAPI.tex', u'OneGov GEVER API Documentation',
...
man_pages = [
    (master_doc, 'onegovgeverapi', u'OneGov GEVER API Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OneGovGEVERAPI', u'OneGov GEVER API Documentation',
     author, 'OneGovGEVERAPI', 'One line description of project.',
     'Miscellaneous'),
]
