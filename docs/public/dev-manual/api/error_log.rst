...
Wenn der Benutzer ein Administrator ist, werden alle Fehler zurückgegeben, ansonsten nur die Fehler, welche mit dem aktuellen Benutzer in Zusammenhang stehen.
...
.. code-block:: json

  {
      ...
      "items_total": 2,
      "restricted_by_current_user": true
...
Administratoren erhalten alle Fehlermeldungen, während normale Benutzer nur die für sie relevanten Fehlermeldungen sehen.
