# -*- coding: utf-8 -*-
#
# OneGov GEVER Dokumentation (intern) build configuration file, created by
# sphinx-quickstart on Wed Feb  3 16:31:54 2016.
#
...
htmlhelp_basename = 'OneGovGEVERInterndoc'
...
latex_documents = [
    (master_doc, 'OneGovGEVERIntern.tex', u'OneGov GEVER Dokumentation (intern)',
...
man_pages = [
    (master_doc, 'OneGovGEVERIntern', u'OneGov GEVER Dokumentation (intern)',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OneGovGEVERIntern', u'OneGov GEVER Dokumentation (intern)',
     author, 'OneGovGEVERIntern', 'One line description of project.',
     'Miscellaneous'),
]
