...
| S23 | Konsistenztests Verschieben (Berechtigungen, Sperren, Sonderfälle) | D4 | 60 | gelb | Objekt-Sperre während Warteschlange umgesetzt & getestet (MOVE_LOCK); verbleibende Sonderfälle (fehlende Rechte, weitere Race-Fälle) auszubauen | spec-lock-objects-during-move.md |
